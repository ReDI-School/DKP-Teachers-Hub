...
* Always edit the Google Slides first, so we keep a trackable version.
* Afterward, duplicate the Kahoot and make changes there (since Kahoot does not save editing history).

#### Access to Content

All materials are regularly updated by the ReDI team. You’ll find the links to the content in the Organizational Spreadsheet & Content Roadmap.&#x20;

...
* Start programming. While presenting, create a first programm.
...
⏱️**Zeitplan:** Aufwärmen: 10 Min. → Unsere Klassenregeln: 10 min → Cyber Guard Mission: 20 min → Einführungstour durch Scratch: 20 Min. → Tastenkombinationen: 10 Min. → Einführungstour durch Scratch: 15 Min. → Erstes Programm: 30 Min. → Kahoot: 10 Min.
...
⏱️**Timing guide:** Warm-up: 10 min → Our class rules: 10min → Cyber Guard Mission: 20min  → Scratch intro tour: 20 min → Shortcuts: 10 min →  First program: 30 min → Kahoot: 10 min.
...
⏱️**Zeitplan:** Aufwärmphase: 15 Min. → Wiederholung: 10 min. → Daumen hoch/runter Spiel: 5 min. → Schleifen in Scratch: 20 min. → Animationsprojekt: 45 Min. → Kahoot: 10 Min.\
...
⏱️**Timing guide:** Warm-up: 15 min. → Recap: 10 min → Thumbs up/down game: 5 min. → Loops in Scratch: 20 min. → Animation project: 45 min. → Kahoot: 10 min.\
...
⏱️**Zeitplan:** Aufwärmung: 10 Min. → Wiederholung: 10 Min. → Erklärung der Nachrichten: 15 Min. → Startmenü: 25 Min. → Spiel & Abschlussphasen: 30 Min. → Kahoot: 10 Min.\
...
⏱️**Timing guide:** Warm-up: 10 min → Recap: 10 min. → Broadcast explanation: 15 min → Start Menu: 25 min → Game + End phases: 30 min → Kahoot: 10 min.\
